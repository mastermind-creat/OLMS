...
<div class="container">
  ...
  <div class="row mt-5">
    ...
    <div class="col-md-4">
      <div class="card text-center shadow-sm">
        <div class="card-body">
          <i class="bi bi-bookshelf display-4 text-warning"></i>
          <h5 class="card-title mt-3">Manage Inventory</h5>
          <p class="card-text">Add, edit, or remove books in the library.</p>
          <a href="#" class="btn btn-warning">Manage Inventory</a>
        </div>
      </div>
    </div>
  </div>
