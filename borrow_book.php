...
if (isset($_GET['book_id'])) {
    ...
    if ($book_result->num_rows > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $sql = "INSERT INTO borrowed_books (book_id, user_id, days, total_cost) VALUES ($book_id, $user_id, $days, $total_cost)";
            if ($conn->query($sql) === TRUE) {
                echo "<script>alert('Book borrowed successfully! Total cost: Ksh. $total_cost'); window.location.href='member_dashboard.php';</script>";
            } else {
